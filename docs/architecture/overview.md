...
- `codestory-retrieval` owns the project-local SQLite lexical and vector generations, SCIP health, retrieval manifests, product embedding checks, and fail-closed query execution.
