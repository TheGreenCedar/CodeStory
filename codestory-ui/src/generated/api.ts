...
export type AgentAnswerDto = { answer_id: string; prompt: string; summary: string; sections: AgentResponseSectionDto[]; citations: AgentCitationDto[]; subgraph_ids: string[]; retrieval_version: string; graphs: GraphArtifactDto[]; retrieval_trace: AgentRetrievalTraceDto }

export type AgentAskRequest = { prompt: string; retrieval_profile?: AgentRetrievalProfileSelectionDto; focus_node_id?: NodeId | null; max_results?: number | null; response_mode?: AgentResponseModeDto; latency_budget_ms?: number | null; include_evidence?: boolean; hybrid_weights?: AgentHybridWeightsDto | null; connection?: AgentConnectionSettingsDto }

export type AgentBackend = "codex" | "claude_code"

export type AgentCitationDto = { node_id: NodeId; display_name: string; kind: NodeKind; file_path: string | null; line: number | null; score: number; subgraph_id?: string | null; evidence_edge_ids?: EdgeId[]; retrieval_score_breakdown?: RetrievalScoreBreakdownDto | null }
...
export type AgentHybridWeightsDto = { lexical?: number | null; semantic?: number | null; graph?: number | null }

export type AgentResponseBlockDto = { kind: "markdown"; markdown: string } | { kind: "mermaid"; graph_id: string }

export type AgentResponseModeDto = "markdown" | "structured"
...
export type AgentRetrievalStepKindDto = "search" | "semantic_query_embedding" | "semantic_candidate_retrieval" | "hybrid_rerank" | "trail_filter_options" | "neighborhood" | "trail" | "node_details" | "node_occurrences" | "edge_occurrences" | "source_read" | "mermaid_synthesis" | "answer_synthesis" | "local_agent"
...
export type RetrievalScoreBreakdownDto = { lexical: number; semantic: number; graph: number; total: number }
