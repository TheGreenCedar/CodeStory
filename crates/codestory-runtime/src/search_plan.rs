use super::{
    ...
    SearchRepoTextMode, SearchRequest, SearchResultsDto, Storage, TrailConfigDto, agent,
    architecture_query_intents, clamp_usize_to_u32, compare_search_hits_with_project_root,
