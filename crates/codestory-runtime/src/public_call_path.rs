//! Product runtime facade for exact indexed call-path verification.
//!
...
use crate::call_path_kernel::{
    COMPACT_PROOF_MAX_BYTES, CONTRACT_INTERPRETATION, CallPathSpec,
    InternalCorePublicationIdentity, InternalProjection, ProofHashes, TranslationGap,
...
use crate::indexed_source_call_path_v1::ObservedIntegratedProjectedCallPathResult;

/// Fact constructors used by downstream protocol tests, never by shipping code.
...
pub mod test_support {
    pub use crate::call_path_kernel::{
        ...
        InternalProjection, PinnedNodeIdentity, ProofContractField, ProofHashes, ReceiptRef,
        ResolvedNodeIdentity, UnavailableReason, UnvalidatedCallPathContract,
...
/// Identifies the request domain observed by the public verifier.
...
mod tests {
    ...
    fn qualification_facade_exposes_only_runtime_owned_execution() {
        let source = include_str!("public_call_path.rs");
