...
pub use crate::search::engine::{
    ...
    EMBEDDING_LAYER_NORM_ENV, EMBEDDING_MODEL_ID_ENV, EMBEDDING_POOLING_ENV, EMBEDDING_PROFILE_ENV,
...
pub mod model_config {
    pub use crate::search::engine::{
        EMBEDDING_BACKEND_ENV, EMBEDDING_DOCUMENT_PREFIX_ENV, EMBEDDING_EXPECTED_DIM_ENV,
        EMBEDDING_LAYER_NORM_ENV, EMBEDDING_MODEL_ID_ENV, EMBEDDING_POOLING_ENV,
        EMBEDDING_PROFILE_ENV, EMBEDDING_QUERY_PREFIX_ENV, EMBEDDING_RUNTIME_MODE_ENV,
        EMBEDDING_TRUNCATE_DIM_ENV, LLAMACPP_EMBEDDINGS_URL_ENV, LLAMACPP_REQUEST_COUNT_ENV,
