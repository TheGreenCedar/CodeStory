...
#[cfg(test)]
// Legacy source-text claim profiles are retained only as regression comparators. Product packet
// construction uses typed obligations, evidence roles, and graph relations instead.
