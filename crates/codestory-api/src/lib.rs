...
pub use dto::{
    ...
    SearchHit, SearchHitOrigin, SearchRequest, SetUiLayoutRequest, SnippetContextDto,
    SourceOccurrenceDto, StartIndexingRequest, StorageStatsDto, SymbolContextDto, SymbolSummaryDto,
