...
pub use storage_impl::{
    ...
    FileContentHash, FileInfo, FileProjectionRemovalSummary, FileRole, GroundingCallDegree,
    ...
    LlmSymbolDocStats, ProjectionFlushBreakdown, ProjectionPersistenceFamilyStats,
    ProjectionPersistenceStats, RetrievalIndexManifest, RetrievalIndexRollbackRecord,
