...
pub use storage_impl::{
    ...
    IndexArtifactCacheEntry, IndexArtifactCacheReader, IndexArtifactCacheWrite,
    ...
    RehydratedCacheRebaseStats, RetrievalIndexManifest, RetrievalIndexRollbackRecord,
