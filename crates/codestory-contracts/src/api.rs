...
pub use dto::{
    ...
    SearchHit, SearchHitOrigin, SearchHybridLimitsDto, SearchRepoTextMode, SearchRequest,
    SearchResultsDto, SetUiLayoutRequest, SnippetContextDto, SourceOccurrenceDto,
    StartIndexingRequest, StorageStatsDto, SummaryGenerationDto, SymbolContextDto,
