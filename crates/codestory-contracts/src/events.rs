use crate::graph::{EdgeId, EdgeKind, NodeId, NodeKind, SourceLocation, TrailMode};
...
pub enum Event {
    ...
    TrailConfigChange {
        depth: u32,
        direction: crate::graph::TrailDirection,
    ...
    SetLayoutDirection(crate::graph::LayoutDirection),
