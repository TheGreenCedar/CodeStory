use super::super::rendering::build_numbered_search_hit_output;
use super::failure::{
    CLI_ERROR_MARKDOWN_ALTERNATIVE_LIMIT, CliErrorBody, CliErrorOutput, StructuredCommandFailure,
    quote_command_argument_value, quote_command_path,
};
use crate::{
    args, display,
...
pub(in crate::app) fn structured_ambiguous_target_failure<T>(
    runtime: &RuntimeContext,
...
pub(in crate::app) fn ambiguous_command_failure(
...
pub(in crate::app) fn render_cli_error_markdown(output: &CliErrorOutput) -> String {
...
pub(in crate::app) fn cli_error_markdown_message(output: &CliErrorOutput) -> &str {
