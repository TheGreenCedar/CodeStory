use codestory_contracts::api::{
    ...
    PacketBudgetModeDto, PacketBudgetUsageDto, PacketPlanDto, PacketPlanQueryDto,
    PacketRetrievalTraceSummaryDto, PacketDispositionDto, PacketTaskClassDto, ProjectSummary,
...
pub(super) fn sample_task_brief_packet() -> AgentPacketDto {
    ...
    AgentPacketDto {
            ...
            support: vec![
                SupportUnitDto {
                    id: format!("symbol:{}", source.node_id.0),
                    kind: SupportUnitKindDto::SymbolLocation,
                    summary: format!(
                        "{} at {}:{}",
                        source.display_name,
                        source.file_path.as_deref().unwrap_or("unknown"),
                        source.line.unwrap_or(0)
                    ),
                    path: source.file_path.clone(),
                    symbol_id: Some(source.node_id.0.clone()),
                ...
                SupportUnitDto {
                    id: format!("symbol:{}", test.node_id.0),
                    kind: SupportUnitKindDto::SymbolLocation,
                    summary: format!(
                        "{} at {}:{}",
                        test.display_name,
                        test.file_path.as_deref().unwrap_or("unknown"),
                        test.line.unwrap_or(0)
                    ),
                    path: test.file_path.clone(),
                    symbol_id: Some(test.node_id.0.clone()),
...
pub(super) fn sample_phase_timings() -> IndexingPhaseTimings {
    IndexingPhaseTimings {
        ...
        incremental_plan_probe: Some(IncrementalPlanProbeTimings {
            ...
            skipped_database_copies: 0,
            skipped_database_copy_bytes: 0,
            skipped_search_state_rebuild: false,
        }),
